...
f = open('/media/wangjinchao/bankcard/data/train.json')
result = json.load(f)

output_path = os.path.join('/media/wangjinchao/bankcard/data/tfrecord', 'train.record')
#output_crop_base = 'E:\\PythonExp\\vehicle_license\\data\\252_clean_in_500_crop'
image_base = '/media/wangjinchao/bankcard/images'
